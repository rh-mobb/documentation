...
1. Create a private ARO cluster.<br>
...
## Create an instance of Azure Front Door
```
...
## Update DNS
1. Get a validation token from Front Door so Front Door can validate your domain 
...
--resource-group $ARORG \
--name score \
k--server-name microsweeper-database
```
...
1. Deploy the [minesweeper application](https://github.com/redhat-mw-demos/microsweeper-quarkus/tree/ARO)
```
