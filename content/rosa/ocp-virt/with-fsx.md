...
> Note: Make sure generated FSX_ADMIN_PASS and SVM_ADMIN_PASS passwords are per
> [Fsx password policy](https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/updating-admin-password.html), otherwise following clodformation will fail.
