...
If you need to install a ROSA cluster, please read our [ROSA Quickstart Guide](/experts/quickstart-rosa.md). Please be sure you are installing or using an existing ROSA cluster that it is 4.10.x or higher.
