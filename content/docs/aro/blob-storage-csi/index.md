...
In the Azure Portal, go to AAD and register a new application with a proper name to identify that this registration is for the driver to access the Blob Storage

![Image](Images/blob-sp0.png)

![Image](Images/blob-sp1.png)

Once created, take note of the Client Id in the overview section.
...
Then, you need to create a secret for this registration. Go to "certificates & secrets" within the registration and create the new secret.

![Image](Images/blob-sp2.png)

Take note of the secret just created, and copy the value of it.
