...
Once completed, you can run your ARO-related questions and see how well the model responds. Please note that it might take a few minutes before it responds.

This is what I'm getting when I typed in a question of "what is aro?" (please note that the outcomes may vary):
...
Once the model is deployed, you will have details on your deployment's info and its endpoint's target URI and keys. We will use the latter two for the next section of the tutorial, so please keep them handy. 
...
You can now start putting in your question and it will provide the response from both systems. This is what I've got when I put in the same question as before, i.e. "what is aro?" (please note that the outcomes may vary):
