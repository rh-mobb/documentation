...
* An OpenShift Dedicated CCS cluster on Google Cloud with **Workload Identity Federation (WIF)**. See the product docs for [creating an OSD GCP cluster with WIF](https://docs.openshift.com/dedicated/osd_getting_started/osd-getting-started.html).
