...
![UI Create Project](/experts/misc/jup/images/3-createprojectname.png)
...
![UI Install Open Data Hub](/experts/misc/jup/images/3-installedoperator.png)
...
![UI Install Open Data Hub](/experts/misc/jup/images/3-createinstance.png)
...
status: {}
```
![UI KFyaml](/experts/misc/jup/images/3-KFyaml.png)
...
![UI Project workload](/experts/misc/jup/images/3-projectworkload.png)

13. Click Routes under Networking and url to launch Jupyterhub is created
![UI Project workload routes](/experts/misc/jup/images/3-projectworkload-routes.png)

14. Open JupyterHub on web browser
![UI JupyterHub](/experts/misc/jup/images/3-jupyterhub.png)

15. Configure GPU and start server
![UI Start Server](/experts/misc/jup/images/3-jupyterhub-gpu-size-startserver.png)

16. Check for GPU in notebook
![UI GPUCheck](/experts/misc/jup/images/3-GPUcheck_notebook.png)
